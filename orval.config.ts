...
export default defineConfig({
    ...
    output: {
      ...
      override: {
        ...
        operations: {
          ...
          technical_nudge_api_nudges_technical_post: {
            query: { useQuery: true },
          },
          fundamental_nudge_api_nudges_fundamental_post: {
            query: { useQuery: true },
          },
  ...
  "pipelines-apis": {
    input: {
      target: "./openapi-pipelines.json",
    },
    output: {
      mode: "tags-split",
      target: "./src/api/generated/pipelines-apis",
      schemas: "./src/api/generated/pipelines-apis/models",
      client: "react-query",
      httpClient: "fetch",
      mock: false,
      clean: true,
